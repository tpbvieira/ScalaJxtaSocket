...
// *
// */
//public class AkkaJxtaSocket extends Socket implements PipeMsgListener, OutputPipeListener {
//
//    /**
//     * Logger
//     */
//    private final static Logger LOG = Logger.getLogger(AkkaJxtaSocket.class.getName());
...
//     */
//    protected AkkaJxtaSocketInputStream nonReliableInputStream = null;
//
//    /**
//     *  The unreliable output stream we use for sending data if 
//     *  {@link #isReliable} is {@code false}.
//     */
//    protected AkkaJxtaSocketOutputStream nonReliableOutputStream = null;
//
//    /**
...
//     */
//    public AkkaJxtaSocket() {}
//
//    /**
//     * This constructor is used by JxtaServer socket for creating AkkaJxtaSocket
...
//     */
//    protected AkkaJxtaSocket(PeerGroup group, PipeAdvertisement pipeAdv, PipeAdvertisement remoteEphemeralPipeAdv, PeerAdvertisement remotePeerAdv, Credential localCredential, Credential remoteCredential, boolean isReliable) throws IOException {
//
...
//
//    /**
//     * Create a AkkaJxtaSocket connected to the give JxtaSocketAddress.
//     *
//     * @param address JxtaSocketAddress to connect to
//     * @throws IOException if an io error occurs
//     */
//    public AkkaJxtaSocket(SocketAddress address) throws IOException {
...
//     * @throws IOException if an io error occurs
//     */
//    public AkkaJxtaSocket(PeerGroup group, PipeAdvertisement pipeAdv) throws IOException {
...
//     *                                the timeout occurs.
//     */
//    public AkkaJxtaSocket(SocketAddress address, int timeout) throws IOException {
...
//     *                                the timeout occurs.
//     */
//    public AkkaJxtaSocket(PeerGroup group, PipeAdvertisement pipeAdv, int timeout) throws IOException {
...
//     *                                the timeout occurs.
//     */
//    public AkkaJxtaSocket(PeerGroup group, PeerID peerid, PipeAdvertisement pipeAdv, int timeout) throws IOException {
...
//     *                                the timeout occurs.
//     */
//    public AkkaJxtaSocket(SocketAddress address, int timeout, boolean reliable) throws IOException {
...
//     *                                the timeout occurs.
//     */
//    public AkkaJxtaSocket(PeerGroup group, PeerID peerid, PipeAdvertisement pipeAdv, int timeout, boolean reliable) throws IOException {
//
//        this.isReliable = reliable;
//        connect(group, peerid, pipeAdv, timeout);
//    }
...
//        
//        if (!closed) Logging.logCheckedWarning(LOG, "AkkaJxtaSocket is being finalized without being previously closed. This is likely a users bug.");
//        close();
//        super.finalize();
//
//    }
...
//
//    /**
//     * Connects to a AkkaJxtaServerSocket on any peer within the default timeout of 60 seconds
//     *
//     * @param group   group context
//     * @param pipeAdv PipeAdvertisement
//     * @throws IOException if an io error occurs
...
//
//    /**
//     * Connects to a AkkaJxtaServerSocket on any peer within a timeout specified in milliseconds
//     *
//     * @param group   group context
//     * @param pipeAdv PipeAdvertisement
...
//
//    /**
//     * Connects to a AkkaJxtaServerSocket on a specific peer within a timeout specified in milliseconds
//     *
//     * @param group   group context
...
//
//                msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                        new TextDocumentMessageElement(AkkaJxtaServerSocket.credTag, credDoc, null));
//            } catch (Exception failed) {
...
//
//        msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                new TextDocumentMessageElement(initiator ? AkkaJxtaServerSocket.reqPipeTag : AkkaJxtaServerSocket.remPipeTag,
//                (XMLDocument) pipeAdv.getDocument(MimeMediaType.XMLUTF8), null));
//
//        msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                new TextDocumentMessageElement(AkkaJxtaServerSocket.remPeerTag,
//                (XMLDocument) group.getPeerAdvertisement().getDocument(MimeMediaType.XMLUTF8), null));
//
//        msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                new StringMessageElement(AkkaJxtaServerSocket.streamTag, Boolean.toString(isReliable), null));
//
//        return msg;
//    }
//
...
//            }
//        } else {
//            nonReliableInputStream = new AkkaJxtaSocketInputStream(this, windowSize);
//            nonReliableOutputStream = new AkkaJxtaSocketOutputStream(this, outputBufferSize);
//        }
//
...
//        MessageElement element = message.getMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE, AkkaJxtaServerSocket.closeTag);
//
//        if (element != null) {
//
//            Logging.logCheckedFine(LOG, "Handling a close message ", this, " : ", element);
//            
//            if (AkkaJxtaServerSocket.closeReqValue.equals(element.toString())) {
//
//                try {
//
...
//                }
//
//            } else if (AkkaJxtaServerSocket.closeAckValue.equals(element.toString())) {
//
...
//            element = message.getMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE, AkkaJxtaServerSocket.remPipeTag);
...
//            }
//
//            element = message.getMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE, AkkaJxtaServerSocket.remPeerTag);
...
//            }
//
//            element = message.getMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE, AkkaJxtaServerSocket.credTag);
...
//            }
//
//            element = message.getMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE, AkkaJxtaServerSocket.streamTag);
...
//        if (!isReliable) {
//            // is there data ?
//            Iterator<MessageElement> dataElements = message.getMessageElements(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                    AkkaJxtaServerSocket.dataTag);
//
...
//        msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE
//                ,
//                new StringMessageElement(AkkaJxtaServerSocket.closeTag, AkkaJxtaServerSocket.closeReqValue, null));
//
...
//        Message msg = new Message();
//        msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                new StringMessageElement(AkkaJxtaServerSocket.closeTag, AkkaJxtaServerSocket.closeAckValue, null));
//
...
//            Message msg = new Message();
//            msg.addMessageElement(AkkaJxtaServerSocket.MSG_ELEMENT_NAMESPACE,
//                    new ByteArrayMessageElement(AkkaJxtaServerSocket.dataTag, MimeMediaType.AOS, bufCopy, 0, length, null));

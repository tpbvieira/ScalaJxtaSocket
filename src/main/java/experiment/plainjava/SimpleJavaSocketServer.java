...
public class SimpleJavaSocketServer {
	...
	public static void main(String args[]) {		
		try {
			Thread.currentThread().setName(SimpleJavaSocketServer.class.getName() + ".main()");
			SimpleJavaSocketServer socEx = new SimpleJavaSocketServer();
			socEx.run();
		} catch (Throwable e) {
			e.printStackTrace();
		}

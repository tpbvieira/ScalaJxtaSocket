...
public class SimpleJxtaSocketServer {

	private PeerGroup netPeerGroup = null;
	public static final String serverName = "SimpleJxtaSocketServer";

	public SimpleJxtaSocketServer() throws IOException, PeerGroupException {
	...
	public static PipeAdvertisement createSocketAdvertisement() {
		...
		advertisement.setName("SimpleJxtaSocketServerPipe");
		return advertisement;
	}

	public void run() {
		System.out.println("### Starting SimpleJxtaSocketServer");
	...
	public static void main(String args[]) {
		...
		try {
			Thread.currentThread().setName(SimpleJxtaSocketServer.class.getName() + ".main()");
			SimpleJxtaSocketServer socEx = new SimpleJxtaSocketServer();
			socEx.run();
		} catch (Throwable e) {
			e.printStackTrace();
		}
